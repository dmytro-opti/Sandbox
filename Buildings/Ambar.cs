...
namespace Sandbox1.Buildings
{
    public class Ambar1 : Building
    {
        ...
        public Ambar1(string address, AmbarType ambarType) : base(address)
        {
            AmbarType = ambarType;
        ...
        public Ambar1(string address, AmbarType ambarType, List<ItemType> allowedItemTypes) : base(address)
        {
            AmbarType = ambarType;
            CurrentUpdatePrice = AmbarLevelUpPrice.Level1;
            CurrentAmbarCapacity = AmbarLevelUpCapacity.Level1;
